...
class OpenRouterAgentManager:
    def __init__(self, api_key, model_tiers=None):
        ...
        self.model_tiers = model_tiers or {
            'tier1': {
                ...
                'cost_per_1k_tokens': 0.0002,  # Input tokens
                'output_cost_multiplier': 3,    # Output tokens typically cost more
                'max_tokens': 4096
            },
            'tier2': {
    ...
    def query_agent(self, agent_type: str, message: str, context: Dict[str, Any] = None, 
        ...
        try:
            ...
            raise ValueError(f"Invalid tier: {starting_tier}")
        ...
        for tier_idx in tier_range:
            ...
            tier_config = self.model_tiers[current_tier]
            ...
            if response_data and 'choices' in response_data and len(response_data['choices']) > 0:
                ...
                input_cost = (prompt_tokens / 1000) * tier_config['cost_per_1k_tokens']
                output_cost = (completion_tokens / 1000) * tier_config['cost_per_1k_tokens'] * tier_config['output_cost_multiplier']
    ...
    def get_usage_report(self) -> Dict[str, Any]:
        ...
        for tier, tokens in self.usage_stats.items():
            ...
            tier_cost = (input_tokens / 1000) * tier_config['cost_per_1k_tokens']
            tier_cost += (output_tokens / 1000) * tier_config['cost_per_1k_tokens'] * tier_config['output_cost_multiplier']
